...
public class MercadoriaControle {
	...
	@GetMapping("/listarMercadoriasPorEmpresa/{empresaId}")
    public ResponseEntity<?> listarMercadoriasPorEmpresa(@PathVariable Long empresaId) {
        ...
        List<Mercadoria> mercadorias = empresa.getMercadorias();

        if (mercadorias.isEmpty()) {
            return new ResponseEntity<>("Nenhuma mercadoria encontrada para esta empresa.", HttpStatus.NOT_FOUND);
        }
        new AdicionadorLinkMercadoria().adicionarLink(mercadorias);
        return new ResponseEntity<>(mercadorias, HttpStatus.OK);
    }
